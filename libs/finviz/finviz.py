...
class FinViz:
    ...
    def __init__(self, specific_site = 'http://finviz.com'):
        """
        ...
        """
        #make the request
        request = requests.get(specific_site)
        #maxe the soup
    ...
    def getMarketRatio(self):
        """ Returns number and percent of stocks
        advancing and number and percent of stocks
        declining"""
...
def test():
    print("testing now")
    testObject_1 = FinViz()
    #FinViz('http://web.archive.org/web/20170316120719/http://finviz.com/')
    testObject_2 = \
    FinViz('http://web.archive.org/web/20170823080826/http://www.finviz.com/')
    data = testObject_1.getTrends()
    for i in data:
        print(i)
